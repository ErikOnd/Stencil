	...
	return (
		<aside className={clsx(styles.sidebar, mobileOpen && styles.sidebarOpen)}>
			...
			<div className={styles.accountWrap}>
				{accountOpen
					? <AccountMenu displayName={displayName} email={email} onLogout={onLogout} onDelete={onDelete} />
					: null}

				<button
					className={clsx(styles.accountButton, accountOpen && styles.accountButtonOpen)}
