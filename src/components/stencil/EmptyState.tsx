...
type EmptyStateProps =
  | { kind: "none"; examples: PromptDraft[]; onExample: (draft: PromptDraft) => void; onNew: () => void; onClear?: never; search?: never }
      ...
      <div className={styles.empty}>
        ...
        <div className={styles.examples} aria-label="Starter prompt examples">
          {props.examples.map((example) => (
            <button className={styles.exampleButton} key={example.title} onClick={() => props.onExample(example)} type="button">
              <span>
